...
@section('breadcrumb')
<a href="{{ url('/dashboard') }}">Dashboard</a><span>/</span><a href="{{ route('laporan_pa.index') }}">Laporan PA</a><span>/</span>Edit
@endsection
                            ...
                            <div class="gkkd-form-group">
                                ...
                                <select name="wilayah_id" id="wilayah_id" class="gkkd-form-control" required>
                                    ...
                                    @foreach ($wilayahs as $wilayah)
                                        <option value="{{ $wilayah->id }}" {{ old('wilayah_id', $laporanPa->wilayah_id) == $wilayah->id ? 'selected' : '' }}>
